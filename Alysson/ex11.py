...
após um mês. Considere fixo o juro da poupança em 0,70% am"""
...
o valor total depois da quantidade de meses chuvosos"""

valori  =  float ( input ( 'Valor depositado: ' ))
meses  =  int ( input ( 'Mesas aplicadas: ' ))
taxa  =  0,70

montante  =  valori  * (( 1  +  taxa ) **  meses )

print ( f'O montante ao final dos { meses } meses será R$ { rodada ( montante ) } . ' )